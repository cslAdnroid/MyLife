...
public class TitleBarView extends LinearLayout {
	...
	public enum TitleBarStyle {
		...
		LeftImg_LeftTxt_Title_RightTxt/** 左边图片左边文字右边文字中间标题文字 **/
	}
	...
	private void initStyle(TitleBarStyle style) {
		switch (style) {
			...
			case LeftImg_Title_TitleImg_RightTxt:
				...
				break;
			case LeftImg_LeftTxt_Title_RightTxt:
				setViewsVisibleAndOtherGone(mLeftImg,mLeftTxt, mTitle, mRightTxt);
				break;
		}
	}
	...
	public void initTitleWithTXTDrawable(String title, String leftTxt, int leftTxtDrawableRes, int padding, String rightTxt){
		initStyle(TitleBarStyle.LeftImg_LeftTxt_Title_RightTxt);
		setTitle(title);
		setLeftTxt(leftTxt);
